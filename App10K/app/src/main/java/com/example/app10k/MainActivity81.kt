...
class MainActivity81 : AppCompatActivity() {
    var BoxCombo1: Spinner? = null
    var txtAlumnofase: TextView? = null
    var BTN1: Button? = null

    var BTNR8: Button? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BTNR8?.setOnClickListener(View.OnClickListener { r: View? -> regresarAOriginal() })
